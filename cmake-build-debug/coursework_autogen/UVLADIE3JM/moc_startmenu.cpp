...
QT_MOC_LITERAL(1, 10, 9), // "botChosen"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "onBotClick"
QT_MOC_LITERAL(4, 32, 13) // "onPlayerClick"

    },
    "StartMenu\0botChosen\0\0onBotClick\0"
    "onPlayerClick"
};
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->botChosen((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->onBotClick(); break;
        case 2: _t->onPlayerClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (StartMenu::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartMenu::botChosen)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StartMenu::botChosen(bool _t1)
{
